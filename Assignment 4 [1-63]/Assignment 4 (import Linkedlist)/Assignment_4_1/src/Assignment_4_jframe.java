 ...
 */
/*
การ import คือง่ายคือสั้นคือหวานกรุบ แต่ต้องเข้าใจการทำงานนะไม่งั้นสอบก็ตาย
*/
...
class DoublyLinkedList {//คลาส DoublyLinkedList ของแท้ 

    private LinkedList<Person> data = new LinkedList<>();//เนื้อในที่เป็นการเก็บแบบ LinkedList มี head,tail

    public void addFirst(Person p) {
           data.addFirst(p);//เพิ่มข้อมูลหน้าสุดใน LinkedList ซึ่งมี method ให้อยู่ละสุดปัง
    }

    public LinkedList<Person> data() {//เข้าถึง LinkedList เพราะ LinkedList เป็น private
        return data;
    }

    public void addLast(Person p) {
        data.addLast(p);//เพิ่มข้อมูลท้ายสุดใน LinkedList ซึ่งมี method ให้อยู่ละปังว่ะ
    }

    public void inSert(int index, Person p) {
        data.add(index-1, p);//เพิ่มข้อมูลตาม index ที่เลือก -1 เพราะมันเริ่มที่ 0 อย่างงขอร้อง
        //ซึ่งก็มี method มาให้อยู่ละปังไม่ไหว
    }
...
//Generate
    private void jButtonGenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGenActionPerformed
        ...
        for(int i=0; i<number; i++){//สร้างวัตถุ Person 5 Person เพิ่มลงใน Linked List
            ...
            Doubly.data().add(new Person(name, age));//สร้างวัตถุ Person และเพิ่มลงใน Linked List
        }
...
//addFirst
    private void jButtonAddFirstActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddFirstActionPerformed
        ...
        //สร้างวัตถุ Person และเพิ่มไว้หน้าสุด Linked List จาก rowData ที่เตรียมไว้
